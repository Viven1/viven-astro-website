...
Actualizada: 2026-09-12 · 7 pendientes
...
- **Esperando:** 28 días (aprobado 2026-08-14)
- **Origen:** idea
...
— MEDIDO EL 27/08 (Claude) —
Los números de arriba son SESIONES, y el 82% del tráfico son bots. Contando solo sesiones con actividad humana real, en la ventana en que existe esa medición (desde el 24/08): recursos 107 sesiones → 6 personas (5,6% humano), how-to/explainer 41 → 7 (17%), product video 19 → 3 (16%), brand video 49 → 7 (14%), calculadora 28 → 12 (43%), resto del sitio 676 → 193 (29%).
...
- **Esperando:** 18 días (aprobado 2026-08-24)
...
— MEDIDO EL 27/08 (Claude) —
1.463 visitas al blog EN en 60 días y 0 leads: cierto. Pero de 296 sesiones al blog en la ventana medible, solo 31 son personas (10,5%) — el resto son bots. Un CTA embebido le hablaría a esas 31.
...
- **Esperando:** 18 días (aprobado 2026-08-25)
- **Origen:** idea
...
## #41 — Escalar variante B del Hero CTA EN antes de fin de test
- **Esperando:** 4 días (aprobado 2026-09-07)
- **Origen:** cro · /dashboard/?tab=analytics&sub=cro

Subir el split de B a 70/30 esta semana y monitorear leads/sesión diario; si se mantiene >2x, cortar el test y fijar B como control.

## #42 — Insertar CTA de calculadora a mitad de página en cluster de servicios con bounce >80%
- **Esperando:** 4 días (aprobado 2026-09-07)
- **Origen:** cro · /dashboard/?tab=analytics&sub=cro

Agregar un módulo sticky o inline a mitad de página con link directo a video-cost-calculator y medir cambio en avg_pages y leads por landing en 7 días.

## #43 — Corregir botón sin respuesta en /en/event-video-planner/
- **Esperando:** 4 días (aprobado 2026-09-07)
- **Origen:** cro · /dashboard/?tab=analytics&sub=cro

Inspeccionar el handler del botón (posible bloqueo por JS error o estado disabled mal configurado) y reemplazar por link directo al formulario de contacto/calculadora.
