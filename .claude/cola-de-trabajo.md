...
Actualizada: 2026-08-26 · 5 pendientes
...
- **Esperando:** 11 días (aprobado 2026-08-14)
- **Origen:** idea
...
## #38 — Declarar ganador anticipado en test Hero CTA DE y desviar tráfico a 'Projekt starten'
- **Esperando:** 1 días (aprobado 2026-08-24)
- **Origen:** cro · /dashboard/?tab=analytics&sub=cro

Cortar el test ahora, mover 80-100% del tráfico DE a la variante B, y monitorear leads/semana durante 7 días para confirmar el uplift antes de fijarla como default.
...
- **Esperando:** 1 días (aprobado 2026-08-25)
- **Origen:** idea
